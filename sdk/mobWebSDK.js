...
function LbProtocol() {
    ...
    */
    ...
    /**
     * @private
     * @desc 构造 获取当前所在菜单层级位置（所属企业id、项目部id、工程id） 请求参数
     * @return {object}
     */
    ...
    /**
     * @private
     * @desc 解析 获取当前所在菜单层级位置（所属企业id、项目部id、工程id） 响应结果
     * @return {object} - 定义参见：{@link onLbCompleted} opRes对象
     */
...
function LbBase() {
	...
	*/
    ...
    /**
     * @typedef CurMenuPos 位置信息
     * @property {String} corpId - 企业id
     * @property {String} corpName - 企业名称
     * @property {String} depId - 项目部id
     * @property {String} depName - 项目部名称
     * @property {String} projId - 工程id
     * @property {String} projName - 工程名称
     */
	/**
	* @desc 获取当前页面所在的菜单位置，返回当前所属企业、项目部(可为空）、工程(可为空）
	* [required nativeSdkVer >= 1]
	* @method
     * @param {Callback} funCompleted - 完成回调，定义参见：{@link onLbCompleted}，data数据结构：{@link CurMenuPos}
	*/
    ...
    /**
     * @typedef RefProj 工程信息
     * @property {Number} ppid - 工程id，唯一标识
     * @property {String} projName - 工程名称
     * @property {Number} projType - 工程类型
     */
    /**
     * @typedef RefComp 工程构件信息
     * @property {String} floor - 楼层
     * @property {String} compClass - 大类
     * @property {String} subClass - 小类
     * @property {String} spec - 专业，仅安装类型有效
     * @property {String} handle - 构件handle，唯一标识
     * @property {String} attrname - 构件名称
     */
    /**
     * @typedef RefCompType 工程构件类型信息
     * @property {String} floor - 楼层
     * @property {String} compClass - 大类
     * @property {String} subClass - 小类
     * @property {String} spec - 专业，仅安装类型有效
    ...
    * @param {Number} refInfo.type - 关联类型，定义参见：{REF_TO_PROJECT ; REF_TO_COMP ; REF_TO_COMP_TYPE}
    * @param {String} refInfo.refId - id，native回传，选填
    * @param {Callback} funCompleted - 完成回调，定义参见：{@link onLbCompleted}
    */
     ...
     * @param {Number} refDetail.type - 关联类型，定义参见：{REF_TO_PROJECT ; REF_TO_COMP ; REF_TO_COMP_TYPE}
     * 值为1（REF_TO_PROJECT）时 : refProj有效；
     * 值为2（REF_TO_COMP）时 : refProj，refComps有效；
     * 值为3（REF_TO_COMP_TYPE）时 : refProj，refCompTypes有效；
     * @param {String} refDetail.refId id
     * @param {RefProj} refDetail.refProj - 关联到工程
     * @param {Array<RefComp>} refDetail.refComps - 关联到构件
     * @param {Array<RefCompType>} refDetail.refCompTypes - 关联到构件类型
	 * @param {Callback} funCompleted - 完成回调，定义参见：{@link onLbCompleted}
    */
    ...
    /**
     * @typedef PageInfo 页面信息
     * @property {PageInfoConfig} config - 页面信息配置
     * @property {String} initParam - 页面初始化数据，可以通过{@link LbBase#getPageInitParam}方法获取数据，选填
     */
    /**
     * @typedef PageInfoConfig 页面信息配置
     * @property {String} title - 标题
     * @property {String} titleColor - 标题颜色
     * @property {String} titleGravity - 标题位置
     * @property {Boolean} showBack - 是否显示返回按钮
     * @property {Boolean} showClose - 是否显示关闭按钮
     * @property {Boolean} showStatusBar - 是否显示状态栏，仅fullScreen=true时有效，否则忽略
     * @property {String} backgroundColor - 背景色
     * @property {Boolean} fullScreen - 是否全屏
     */
	/**
	* @desc 新开一个本地web页面 url : http://www.xxx.html?pageInfo=urlEncode(x) pageInfo -- 页面信息，格式参考：{@link PageInfo}
	* [required nativeSdkVer >= 1]
	* @method
